...
class FileLoggerTests: XCTestCase {
    ...
    func testFileLogger() {
        ...
        if let fileLogger = FileLogger(path: path) {
            ...
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [FileLoggerTests.swift-testFileLogger():38]: (info) test 0\n"))
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [fileName 1-functionName 1:10]: (info) test 1\n"))
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [fileName 2-functionName 2:22]: (debug) test 2\n"))
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [fileName 3-functionName 3:23]: (warning) test 3\n"))
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [fileName 4-functionName 4:49]: (error) test 4\n"))
            ...
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [fileName 3-functionName 3:23]: (warning) test 3\n"))
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [fileName 4-functionName 4:49]: (error) test 4\n"))
            XCTAssertTrue(fileLogger.readLogFile()!.contains("[ndt7] [Operation queue: com.apple.main-thread-thread] [fileName 5-functionName 5:45]: (error) test 5\n"))
        } else {
